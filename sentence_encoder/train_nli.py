...
#GLOVE_PATH = "snli_embeddings.txt"

parser = argparse.ArgumentParser(description='NLI training')
# paths
parser.add_argument("--nlipath", type=str, default='dataset/SNLI/', help="NLI data path (SNLI or MultiNLI)")
parser.add_argument("--outputdir", type=str, default='encoder/', help="Output directory")
parser.add_argument("--outputmodelname", type=str, default='model_2048_maxpool.pickle')
...
parser.add_argument("--seed", type=int, default=879, help="seed")
